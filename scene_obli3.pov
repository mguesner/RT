camera
{
	location <4000,-2500, -20> // la position de l'observateur
	look_at <4000,0,0>  // le point de vue
}
...
cone_42 { <5000,1500,0>, 0.3, <0,0.5,-0.5>   // coord, angle, direction
